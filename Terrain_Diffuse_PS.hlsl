...
PixelOutput main(PixelInputType input) // No specular, white diffuse
{
    PixelOutput result;
    ...
    float3 blendedA = albedoGrass.a * grassWeight +
    ...
    float3 diffuseColor = (float3) 1.0f; // White
    float3 specularColor = (float3) 0.0f; // Black
